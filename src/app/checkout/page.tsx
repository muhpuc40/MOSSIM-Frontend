...
const CheckoutContent = () => {
    ...
    const urlShip     = Number(searchParams.get('ship') ?? SHIP_INSIDE)
    ...
    /* ── Shipping (can change on checkout too) */
    ...
    const handlePlaceOrder = async () => {
        ...
        try {
            ...
            // Redirect to my account — orders tab
                        ...
                        <div className="lg:w-3/5 w-full">
                            ...
                            {addrLoading ? (
                                ...
                                <div className="bg-surface p-4 rounded-xl mb-8">
                                    ...
                                    <Link href="/my-account" className="button-main bg-black text-sm px-4 py-2 inline-block">Add Address</Link>
                                </div>
                            ) : (
