        ...
        <div className="container">
          <div className="flex justify-between max-lg:flex-col gap-y-10">
            ...
            <div className="right lg:w-1/4 lg:pl-4">
              <div className="item">
                <div className="heading4">Our Display Center</div>
                <p className="mt-3">
                  01 (Kha), Block #A, House No. 14, Road No. 2/Ka/A, Chattogram
                  4203, Bangladesh
                </p>
                <p className="mt-3">
                  Phone:{" "}
                  <span className="whitespace-nowrap">+88 01322-447700</span>
                </p>
                <p className="mt-1">
                  Email:{" "}
                  <span className="whitespace-nowrap">info@mossim.net</span>
                </p>
              </div>
