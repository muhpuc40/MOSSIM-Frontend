        ...
        <div className="container">
          <div className="content-main flex justify-between max-lg:flex-col gap-y-8 gap-x-10">
            ...
            <div className="lg:w-3/5 w-full">
              ...
              {addrLoading ? (
                <div className="caption1 text-secondary mb-8">
                  Loading addresses...
                </div>
              ) : addresses.length === 0 ? (
                <div className="bg-surface p-4 rounded-xl mb-8">
                  <p className="caption1 text-secondary mb-3">
                    No saved addresses.
                  </p>
                  <Link
                    href="/my-account#address"
                    className="button-main bg-black text-sm px-4 py-2 inline-block">
                    Add Address
                  </Link>
                </div>
              ) : (
                <div className="space-y-3 mb-8">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            {addr.is_default && (
                              <span className="caption2 bg-black text-white px-2 py-0.5 rounded">
                                Default
                              </span>
                            )}
                          </div>
                  ...
                  <Link
                    href="/my-account"
                    className="caption1 text-secondary hover:text-black duration-200 underline block mt-1">
                    + Manage addresses
                  </Link>
                </div>
              )}
              ...
              <button
                ...
                className="w-full p-4 border border-line rounded-xl text-left duration-200 hover:border-black hover:bg-surface mb-8"
              >
            ...
            <div className="lg:w-2/5 w-full">
              <div className="sticky top-24 space-y-5">
                ...
                <button
                  ...
                  disabled={
                    submitting || !selectedAddrId || addresses.length === 0
                  }>
                  {submitting
                    ? "Placing Order..."
