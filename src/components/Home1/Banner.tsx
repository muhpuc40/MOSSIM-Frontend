...
const Banner = () => {
    ...
    const left = leftBanner || { ...defaultBanner, title: 'Best Sellers', image: '/images/banner/1.png' }
    const right = rightBanner || { ...defaultBanner, title: 'New Arrivals', image: '/images/banner/2.png' }
        ...
        <div className="banner-block style-one grid sm:grid-cols-2 gap-5 md:pt-20 pt-10">
            ...
            >
                ...
                <div className="banner-content absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center bg-black/20 rounded-xl">
                    <div className="heading2 text-white text-center px-4">{left.title}</div>
                    {left.subtitle && (
                        <div className="body1 text-white text-center mt-2 px-4">{left.subtitle}</div>
                    )}
            ...
            >
                ...
                <div className="banner-content absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center bg-black/20 rounded-xl">
                    <div className="heading2 text-white text-center px-4">{right.title}</div>
                    {right.subtitle && (
                        <div className="body1 text-white text-center mt-2 px-4">{right.subtitle}</div>
                    )}
                    <div className="text-button text-white relative inline-block pb-1 border-b-2 border-white duration-500 mt-2 group-hover:pb-2">
                        {right.cta_text}
                    </div>
